...
\citet{liang2026lncrna} in HAP1, HEK293FT, K562, MDA-MB-231, and THP1 cells.
...
longitudinal effect with time scaled from 0 to 1 over 14 days.  A replicate
indicator was included when both replicate trajectories contained all three
time points.  K562 lacks one deposited day-0 replicate; all methods therefore
used an unblocked time slope in that cell line rather than fitting an
incomplete matched trajectory.  BARCS guide statistics were calibrated with
...
Benjamini--Hochberg procedure.  MAGeCK-RRA's negative-selection probability
and the deposited Liang RRA probability were retained in their native
depletion-tail form.
