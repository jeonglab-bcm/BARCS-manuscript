...
\begin{enumerate}
  ...
  preprocessed pseudo-counts, that study's own \texttt{RobustRankAggreg}
  analysis---not MAGeCK-RRA---is more powerful and better calibrated than
  either regression likelihood.
