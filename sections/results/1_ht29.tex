...
The day-25 MAGeCK row has the highest AUROC and Recall$_{90}$ in the deposited
comparison.  The full trajectory therefore provides no measured advantage over
the endpoint on these two ranking metrics.  Official continuous-time MAGeCK
