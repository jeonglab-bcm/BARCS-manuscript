...
Two BARCS gene statistics are carried through the genome-scale benchmark.
...
best.  MAGeCK-MLE could not be installed in the analysis environment used for
the genome-scale runs and is reported in the 400-gene comparisons only.
