...
BARCS-MOD leads F1, and it is the only method that combines competitive
ranking with a realized FDP below the nominal target.
...
ranks marginally best while calling least, at FDP 0.003 and F1 0.708.  The one
difference is that MAGeCK-MLE's average-precision margin over BARCS-MOD is
resolvable at this MOI, 0.0033 (0.0017 to 0.0049).
