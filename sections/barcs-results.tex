...
Benjamini--Hochberg adjusted $p<0.05$.  Best means closest to 0.05 for Type I
and empirical FDR, highest for power, lowest for RMSE, and closest to 0.95 for
coverage; discoveries have no universal optimum.}
...
\midrule
\methodswatch{naivegray} Naive binomial $z$ &
  0.844 & \textcolor{naivegray}{\textbf{1.000}} &
  174 & 0.770 & 0.158 & 0.185\\
\methodswatch{barcsblue} BARCS $t$ &
  0.081 & \textcolor{barcsblue}{\textbf{1.000}} &
  46 & 0.130 & 0.156 & \textcolor{barcsblue}{\textbf{0.935}}\\
\methodswatch{mageckorange} Official MAGeCK-MLE Wald &
  \textcolor{mageckorange}{\textbf{0.038}} & 0.975 & 41 &
  \textcolor{mageckorange}{\textbf{0.049}} &
  \textcolor{mageckorange}{\textbf{0.140}} & 0.970\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{(A) Observed versus expected gene-level null $p$-values for the
naive binomial, BARCS, and official MAGeCK-MLE fits.  (B) Observed guide
abundance and the fitted batch-1 BARCS dose response for one truly associated
guide.}
