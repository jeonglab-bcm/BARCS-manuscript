...
\paragraph{The power side of the same picture.}
Scanning the cutoff also shows what each method could achieve if its threshold
were chosen with knowledge of the truth, which a real screen does not have.
\emph{Peak} F1 is essentially tied: 0.827 for BARCS-ST, 0.847 for BARCS-MOD,
0.853 for MAGeCK-MLE, and 0.844--0.847 for the three count models.  MAGeCK-MLE
attains the highest peak of any method, so moderation does not give BARCS
access to more recoverable genes than the alternatives.  What differs is
whether the requested cutoff delivers that peak.  BARCS-MOD is already at its
maximum at 0.10: its argmax is nominally 0.20, but the two are
indistinguishable, 0.8470 against 0.8468, so the shortfall at the reported
cutoff is 0.0002.  MAGeCK-MLE gives up 0.135 of F1 at 0.10 and needs a
requested 0.50 to peak; edgeR-QL, DESeq2, and limma-voom give up 0.021, 0.035,
and 0.022 and reach their peaks at 0.05, 0.01, and 0.05 respectively.  Every
method other than BARCS-MOD needs a cutoff other than the one it was asked
for, and the right choice differs by method and is not identifiable without
the truth.
