...
Bottom left: all-bin BARCS and MAGeCK-MLE effects, with
...
\subsection{Simulation calibration: why the beta-binomial layer matters}
...
make BARCS win.  The binomial-only test estimates the slopes reasonably well, but its standard
