...
guide-consistency statistic increased average precision to 0.664,
directional recall to 0.139, and F1 to 0.232.  It made 58 calls across the
five simulations (2--21 per seed), all of which were active genes under the
simulated truth, for mean realized FDP 0.  The fitted empirical-null scales
were 2.11--2.39, showing why an unscaled guide-score reference would have been
anti-conservative.
...
\caption{Sensitivity to independent screen replication in the
...
diagnostic only.  The open blue BARCS-GC point uses concordant guide
$t$ scores and a robust empirical null; it recovers a conservative subset
without redefining guides as biological replicates.  Several general
count-model pipelines make more discoveries there with inflated FDP.}
