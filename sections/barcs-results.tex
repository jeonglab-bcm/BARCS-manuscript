...
One limitation of this scan is ours rather than the method's.  MAGeCK-MLE was
run with a single permutation round, following the convention used elsewhere
in this repository, which quantizes its gene FDR and gives it a floor: its
call count is constant at 358 and its F1 constant at 0.306 across six orders
of magnitude.  Its behaviour in the strict regime should therefore be read as
an artifact of that setting, not as a property of MAGeCK-MLE.
